...
public class MySwing04 extends JFrame {
	...
	public MySwing04() {
		...
		tf01 = new JTextField();
		tf01.setBounds(12, 21, 42, 21);
		contentPane.add(tf01);
		tf01.setColumns(10);

		tf02 = new JTextField();
		tf02.setColumns(10);
		tf02.setBounds(66, 21, 42, 21);
		contentPane.add(tf02);

		tf03 = new JTextField();
		tf03.setColumns(10);
		tf03.setBounds(123, 21, 42, 21);
		contentPane.add(tf03);

		tf04 = new JTextField();
		tf04.setColumns(10);
		tf04.setBounds(178, 21, 42, 21);
		contentPane.add(tf04);

		tf05 = new JTextField();
		tf05.setColumns(10);
		tf05.setBounds(233, 21, 42, 21);
		contentPane.add(tf05);

		tf06 = new JTextField();
		tf06.setColumns(10);
		tf06.setBounds(289, 21, 42, 21);
